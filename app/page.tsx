    ...
    >
      <motion.div className="flex flex-col gap-5" variants={itemVariants}>
        ...
        <p className="text-dark/75 mx-5 max-w-xl text-center">
          They&apos;re using AI that actually works, faster, smarter, effortless.
          Nexia makes the upgrade simple, and once you switch, you&apos;ll wonder
      ...
      <motion.div
        className="flex flex-col md:flex-row px-7 gap-8 mt-6"
