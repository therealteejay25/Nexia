      ...
      >
        <div className="flex p-1.5 md:w-3xl w-[100%] rounded-full border-4 border-dark/3 bg-[#E9E9E9] justify-between shadow-2xl shadow-dark/5">
          <input
            ...
            className="outline-0 md:w-[70%] px-4 text-xs md:text-md"
          />
          <button
            disabled={loading}
            className="bg-base flex gap-2 justify-center items-center text-xs md:text-md rounded-full py-3 px-5 text-white cursor-pointer font-medium disabled:opacity-60"
          >
